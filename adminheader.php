                        ...
                        <div class="navbar-nav mx-0 mx-lg-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="./addstaff.php" class="dropdown-item">Add Staffs</a>
                                    <a href="./adduser.php" class="dropdown-item">Add Students</a>
                                    <a href="./viewstaff.php" class="dropdown-item">View Staffs</a>
                                    <a href="./viewuser.php" class="dropdown-item">View Students</a>
