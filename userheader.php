...
<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active fs-5" href="./userhome.php">Home</a></li>
                    <li class="nav-item"><a class="nav-link fs-5" href="./userassignments.php">Assignments</a></li>
                    <li class="nav-item"><a class="nav-link fs-5" href="./userreport.php">Report</a></li>
                    <li class="nav-item"><a class="nav-link fs-5" href="./uservideos.php">View Videos</a></li>
                    <li class="nav-item"><a class="nav-link fs-5" href="./usernotes.php">View Notes</a></li>
                    <li class="nav-item"><a class="nav-link fs-5" href="./useraudios.php">View Audios</a></li>
                    <li class="nav-item"><a class="nav-link fs-5" href="login.php">Logout</a></li>
                </ul>
