                ...
                <nav class="navbar navbar-expand-lg navbar-light"> 
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-0 mx-lg-auto">
                            ...
                            <a href="./userassignments.php" class="nav-item nav-link">Assignments</a> 
                            <a href="./userreport.php" class="nav-item nav-link">Report</a> 
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link" data-bs-toggle="dropdown">
                                    <span class="dropdown-toggle">Materials</span>
                                </a>
                                <div class="dropdown-menu">
                                    <a href="./uservideos.php" class="dropdown-item">View Videos</a>
                                    <a href="./usernotes.php" class="dropdown-item">View Notes</a>
                                    <a href="./useraudios.php" class="dropdown-item">View Audios</a>
