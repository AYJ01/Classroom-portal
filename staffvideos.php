                        ...
                        <div>
                            ...
                            <form method="post" enctype="multipart/form-data" >
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control border-0" name="Desc" placeholder="Add the Details About the Videos" id="message" style="height: 120px" required></textarea>
...
if (isset($_POST['submit'])) {
    ...
    move_uploaded_file($_FILES['Image']['tmp_name'],$file);
        ...
        // Insert user data
        $qry2 = "INSERT INTO `videos` (`class`,`staff`, `vdesc`,`video`) VALUES ('$class','$id','$registerno','$file')";
        echo $qry2;
